...
const genderMenuItems = [<MenuItem key={0} value={"MALE"}>
    Herr
</MenuItem>, <MenuItem key={1} value={"FEMALE"}>
    Frau
</MenuItem>, <MenuItem key={2} value={"OTHER"}>
    Divers
</MenuItem>,];
...
export const CreateDepartmentOverlay = ( { closeOverlay } ) => {
    ...
    return (<Overlay onClose={() => closeOverlay()} headerContent={<h2>Neue Abteilung anlegen</h2>} size={"m"}>
        <ValidatorForm
                onSubmit={() => addDepartmentMutation.mutate( departmentBuilder( departmentName, street, houseNumber, postalCode, location, country, gender, firstname, lastname, mail, sendConfirmationMail ) )}
        >
