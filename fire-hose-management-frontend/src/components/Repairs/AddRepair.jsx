...
const AddRepair = () => {
    ...
    return (<DefaultPage>
        ...
        {maintenanceDevices.length === 0 && (<Grid container>
            <Typography>
                Es wurden keine Geräte hinterlegt. Geräte können unter dem Reiter "Geräteübersicht" hinterlegt
                werden.
            </Typography>
        ...
        />*/}
            ...
            <Stack spacing={2} direction="row" className={classes.buttonFooter}>
                <Button color="primary" variant="contained" onClick={() => postDeviceMaintenance()}>
                    Gerätewartung hinterlegen
                </Button>
                <Button
                        color="primary"
                        variant="outlined"
                        onClick={() => navigate( REPAIRS.path, { replace: true } )}
                >
                    Abbrechen
                </Button>
            </Stack>
