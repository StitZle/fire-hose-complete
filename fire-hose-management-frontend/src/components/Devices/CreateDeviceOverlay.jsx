...
export const CreateDeviceOverlay = ( { closeOverlay } ) => {
    ...
    return (<Overlay onClose={() => closeOverlay()} headerContent={<h2>Neues Gerät anlegen</h2>} size={"s"}>
        <Typography variant={"body2"}>
            Die Angabe einer Geräte-Kennung ist nicht Verpflichtend.
            <br/>
            Wird das Feld nicht ausgefüllt so generiert das System automatisch eine Sechsstellige-Kennnummer. Der
            Gerätename sowie die Kennnummer kann nachträglich nicht mehr geändert werden.
        </Typography>
