...
const Devices = () => {
    ...
    return (<DefaultPage>
        ...
        {isEditOverlayVisible && (<EditDeviceOverlay closeOverlay={() => setIsEditOverlayVisible( false )} device={selectedDevice}/>)}

        {isDeleteOverlayVisible && (<DeleteDeviceOverlay closeOverlay={() => setDeleteOverlayVisible( false )} device={selectedDevice}/>)}
    </DefaultPage>);
};
