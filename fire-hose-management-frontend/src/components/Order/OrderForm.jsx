        ...
        <ValidatorForm onSubmit={handleSubmit}>
          <Grid container spacing={3} className={classes.form}>
            <Grid item lg={12} md={12} xs={12}>
              ...
              <ul>
                <li>
                  Zu reinigende Schläuche, die keine Defekte aufweisen, bitte immer aufgerollt in das jeweilige
                  Fahrregal
                  <span className={classes.italic}>"Schläuche benutzt"</span> stellen.
                </li>
                <li>
                  Defekte/beschädigte Schläuche bitte immer mit <b>einem Konten</b> versehen und den defekten Schlauch
                  (wenn möglich gerollt) in die Box <span className={classes.italic}>"Schläuche defekt"</span> stellen.
                </li>
                <li>
                  Saubere Schläuche bitte aus den Fahrregalen <span className={classes.italic}>"Schläuche sauber"</span>{" "}
                  entnehmen. Dazu muss kein Formular ausgefüllt werden.
                </li>
              </ul>
            </Grid>
