              ...
              <Alert severity="info">
                <AlertTitle>Hinweise</AlertTitle>
                  <div className={classes.infoNotes}>
                    ...
                    <span>Zu reinigende Schläuche, die keine Defekte aufweisen, bitte immer aufgerollt in das
                    jeweilige Fahrregal
                    <span className={classes.italic}>"Schläuche benutzt"</span> stellen.</span>
                  </div>
                <div className={classes.infoNotes}>
                  <CheckIcon fontSize="medium"/>
                  <span>Defekte/beschädigte Schläuche bitte immer mit <strong>einem Konten</strong> versehen und den
                    defekten Schlauch (wenn möglich gerollt) in die Box{" "}
                    <span className={classes.italic}>"Schläuche defekt"</span> stellen.</span>
                </div>
                <div className={classes.infoNotes}>
                  <CheckIcon fontSize="medium"/>
                  <span>Saubere Schläuche bitte aus den Fahrregalen{" "}
                    <span className={classes.italic}>"Schläuche sauber"</span> entnehmen. Dazu muss kein
                    Formular ausgefüllt werden.</span>
                </div>
              </Alert>
            </Grid>
